// ORIGINAL CELL IMPLEMENTATION (Before Phase 1.1 Optimization)
// 
// This file is kept for reference and potential rollback.
// Size: 16 bytes per cell
// 
// To rollback optimization:
//   mv src/cell_old.rs src/cell.rs
//   git checkout src/packed_color.rs  # remove this
//
// Key differences from optimized version:
// - OLD: fg: Option<Color>, bg: Option<Color> (8-12 bytes each)
// - NEW: fg_packed: PackedColor, bg_packed: PackedColor (2 bytes each)
// 
// Performance: NEW is 30-83% faster, uses 25% less memory
// ========================================================================
